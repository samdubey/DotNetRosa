...
namespace org.javarosa.core.model.data
{
	...
	/// <summary> A response to a question requesting an GeoTrace Value.
	...
	/// 
	/// </author>
	public class GeoTraceData : IAnswerData, IExprDataType, System.ICloneable
	{
		...
		virtual public System.Object Value
		{
			...
			set
			{
				...
				if (!(value is GeoTrace))
				{
					GeoTraceData t = new GeoTraceData();
					//UPGRADE_TODO: The equivalent in .NET for method 'java.lang.Object.toString' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
					GeoTraceData v = t.cast(new UncastData(value.ToString()));
					value = v.Value;
				}
				GeoTrace gs = (GeoTrace) value;
				//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		/// <summary> The data value contained in a GeoTraceData object is a GeoTrace
		/// 
		/// </summary>
		/// <author>  mitchellsundt@gmail.com
		/// 
