...
namespace org.javarosa.core.model.data
{
	...
	/// <summary> This is not a factory, actually, since there's no drop-in component model, but
	...
	public class AnswerDataFactory
	{
		...
		/// <summary> The one-template to rule them all. Takes in a control type and a
